...
import { NursinghomeList, DataDelete } from "../services/Auth.nursehome";
...
export default function NursingHome() {
  ...
  useEffect(() => {
    const test = async () => {
      const response = await NursinghomeList(input, 5, select);
            ...
            <div class="col-md-12">
              <div class="assist_box">
                ...
                <div class="add_btn nurse_box">
                  <Link to="/addnursinghome">
                    <i class="fas fa-plus"></i> Add Nursing Home
                  </Link>
                </div>
              </div>
            </div>
