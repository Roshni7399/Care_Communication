...
export default function Assistphy() {
  ...
  useEffect(() => {
    ...
    const test = async () => {
      const response = await PhysicianList(search,1,select)
...
if (response.data.status === true) {
  const response = await PhysicianList();
            ...
            <div class="col-md-12">
              <div class="assist_box">
                ...
                <div class="add_btn nurse_box">
                  <a href=""><i class="fas fa-plus"></i> Add Physician</a>
                </div>
              </div>
            </div>
          </div>
